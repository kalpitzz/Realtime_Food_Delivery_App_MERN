...
function updateCart(pizza) {
  //update cart
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', pizza).then(function (resp) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunktoscanopizza"] = self["webpackChunktoscanopizza"] || [];
